...
function Layout()
{
  ...
  { 
    ...
    $('#sidebar_search_program_container').height( searchbox_height );
    ...
    var program_results_container = searchbox_height - 158;
    ...
    $('#sidebar_search_program_results_container').height( program_results_container );

  }

  this.home = function()
  {
    $('#layout_main').html(html.get('modules/programs/programs.html'));
  }
